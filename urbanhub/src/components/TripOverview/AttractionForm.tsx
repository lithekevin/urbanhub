...
import { Modal, Form, DatePicker, TimePicker, Button, AutoComplete, Typography, message } from 'antd';
...
function AttractionForm(props: AttractionFormProps) {
  ...
  const { cityPosition, defaultAttractionImageUrl, editingAttraction, form, imageUrl, isFormVisible, trip,
    ...
    setValidSelection, tripId, validSelection, zoomLevel, messageApi, contextHolder } = props;
            ...
            <Col>
              ...
              <Form.Item name="date" label="Date" rules={[{ required: true, message: 'Please choose the date!' }]}>
                <DatePicker format="DD/MM/YYYY"
                  defaultPickerValue={dayjs(trip?.startDate)} // Set the default picker value to the start date of the trip
