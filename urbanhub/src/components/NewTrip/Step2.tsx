...
const Step2: React.FC<Step2Props> = ({ displayedQuestions, setDisplayedQuestions, allDisplayedQuestions, setAllDisplayedQuestions, canLoadMoreQuestions,setCanLoadMoreQuestions, userAnswers, setUserAnswers, questionsPageNumber, setQuestionsPageNumber, step, prevStep, nextStep }) => {
